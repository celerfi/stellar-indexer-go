...
-- 1-minute OHLCV per source — primary VWAP input
...
SELECT
    ...
    SUM(price_usd * volume_usd) /
        NULLIF(SUM(volume_usd), 0)           AS vwap,
...
-- 1-minute cross-source OHLCV — for charting
