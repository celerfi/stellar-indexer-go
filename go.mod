module github.com/celerfi/stellar-indexer-go

go 1.25.3

require (
	github.com/joho/godotenv v1.5.1
	github.com/stellar/go v0.0.0-20251031221525-cce317fa5beb
	github.com/stellar/stellar-rpc v0.9.6-0.20250814101741-4fd966112195
)
